...
class IdMutator:
    ...
    def __is_not_worth_mutate_to_open_parenthesis(self):
        ...
        if self.pos_to_mutate + 4 >= len_id:
            return True
        else:
    ...
    def __get_chars_available_to_mutate_to(self):
    ...
    # TODO: Implement test to this function.
    def __clean_char_to_mutate_to(self, char_to_mutate_to):
        ...
        # TODO: Have into account 'char_to_mutate_to' might have changed from the code above.
    ...
    def __mutate_id(self):
        ...
        chars_available_to_mutate_to = self.__get_chars_available_to_mutate_to()
        char_to_mutate_to = chars_available_to_mutate_to[random.randint(0, len(chars_available_to_mutate_to) - 1)]
        prefix, char_to_mutate_to, suffix = self.__clean_char_to_mutate_to(char_to_mutate_to)
